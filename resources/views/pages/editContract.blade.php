            ...
            <fieldset title="Podaci o ugovoru">
                ...
                <fieldset>
                    ...
                    <div class="collapse in" id="conData">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label" for="tipTehnologije">Partner:</label>
                            <div class="col-lg-4">
                                @if(isset($partneri))
                            ...
                            <label class="col-lg-2 control-label" for="datum">Naziv ugovora:</label>
                            <div class="col-lg-4">
                                <input type="text" name="nazivUgovora" id="nazivUgovora" class="form-control" placeholder="Naziv ugovora" value="{{ $ugovor->naziv_ugovra }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" placeholder="Broj ugovora" id="brojUgovora" name="brojUgovora" value="{{ $ugovor->broj_ugovora }}" readonly>
                            </div>

                            <label class="col-lg-2 control-label" for="datum">Datum potpisa:</label>
                            <div class="col-lg-4">
                                <input type="text" name="datum" id="datum" class="form-control" pvalue="{{ date("d.m.Y", strtotime($ugovor->datum_potpisivanja)) }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="zbirniRacun" id="zbirniRacun" class="form-control" value="{{ $ugovor->zbirni_racun }}" readonly>
                            </div>
